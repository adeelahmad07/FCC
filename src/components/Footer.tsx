      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-gray-400">
              ...
              <p className="flex items-start gap-2">
                ...
                <br />
                {siteConfig.contact.workingDays}
              </p>
              {siteConfig.offices.map((office) => (
                <p key={office.city} className="flex items-start gap-2">
                  <svg className="w-4 h-4 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                  <span>{office.address}{office.isHQ && " (HQ)"}</span>
                </p>
              ))}
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-whatsapp hover:text-whatsapp-hover text-sm font-medium transition-colors"
          >
